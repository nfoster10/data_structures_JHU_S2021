...
public class PrefixToPostfixConverter
{
	...
	*/
	...
	public boolean recursivePrefixToPostfix(Stack inputEquation, Stack outputEquation)
	{
		...
		if (inputEquation.isEmpty() == false)
		{
			inputChar = (String) inputEquation.pop();

			if(isOperator(inputChar))
			{
				if(outputEquation.isEmpty()==false) pop1 = (String) outputEquation.pop();
			
				if(outputEquation.isEmpty()==false) pop2 = (String) outputEquation.pop();
